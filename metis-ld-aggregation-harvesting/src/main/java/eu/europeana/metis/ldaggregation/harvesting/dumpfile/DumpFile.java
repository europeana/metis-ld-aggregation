...
public abstract class DumpFile {
  ...
  public static DumpFile fromDistribution(InputStream inputStream, Lang dataLanguage, MimeType packageFormat, MimeType compressFormat) throws UnsupportedMimeTypeException, IOException {
    ...
    if(compressFormat==null) {
      ...
      if(packageFormat==null) {
        ...
        throw new UnsupportedMimeTypeException("Package\\compress format not supported: "+packageFormat+ " " + compressFormat);
    }
