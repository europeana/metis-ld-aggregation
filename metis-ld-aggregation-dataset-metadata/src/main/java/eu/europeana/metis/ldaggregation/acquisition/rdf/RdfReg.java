...
//	public static String NsRdfs="http://www.w3.org/2000/01/rdf-schema#";
	...
	public static final Property DQV_HAS_QUALITY_ANNOTATION = ResourceFactory
			.createProperty(NsDqv + "hasQualityAnnotation");
	...
	public static final Resource IIIF_MANIFEST = ResourceFactory
			.createResource("http://iiif.io/api/presentation/2#Manifest");
	...
	public static final Resource IIIF_COLLECTION = ResourceFactory
			.createResource("http://iiif.io/api/presentation/2#Collection");
	...
	public static final Property IIIF_METADATA_LABELS = ResourceFactory
			.createProperty("http://iiif.io/api/presentation/2#metadataLabels");
	public static final Property IIIF_PROFiLE_DOAP_IMPLEMENTS = ResourceFactory
			.createProperty("http://usefulinc.com/ns/doap#implements");
	...
	public static final Property IIIF_NAV_DATE = ResourceFactory
			.createProperty("http://iiif.io/api/presentation/2#presentationDate");
	public static final Property IIIF_HAS_SEQUENCES = ResourceFactory
			.createProperty("http://iiif.io/api/presentation/2#hasSequences");
	public static final Property IIIF_HAS_CANVASES = ResourceFactory
			.createProperty("http://iiif.io/api/presentation/2#hasCanvases");
	public static final Property IIIF_HAS_IMAGE_ANNOTATIONS = ResourceFactory
			.createProperty("http://iiif.io/api/presentation/2#hasImageAnnotations");
	public static final Property SVCS_HAS_SERVICE = ResourceFactory
			.createProperty("http://rdfs.org/sioc/services#has_service");
	...
	public static final Property DCTERMS_IS_REFERENCED_BY = ResourceFactory
			.createProperty(NsDcterms + "isReferencedBy");
	public static final Property DCTERMS_IS_PART_OF = ResourceFactory.createProperty(NsDcterms + "isPartOf");
	public static final Property DCTERMS_TEMPORAL_COVERAGE = ResourceFactory
			.createProperty(NsDcterms + "temporalCoverage");
	...
	public static final Resource SKOS_CONCEPT = ResourceFactory
			.createResource("http://www.w3.org/2004/02/skos/core#Concept");
	public static final Resource SKOS_CONCEPT_SCHEME = ResourceFactory
			.createResource("http://www.w3.org/2004/02/skos/core#ConceptScheme");
	...
	public static final Property DCTERMS_TABLE_OF_CONTENTS = ResourceFactory
			.createProperty(NsDcterms + "tableOfContents");
	...
	public static final Property RDAGR2_PROFESSION_OR_OCCUPATION = ResourceFactory
			.createProperty(NsRdaGr2 + "professionOrOccupation");
	...
	public static final Property OWL_EQUIVALENT_CLASS = ResourceFactory
			.createProperty(RdfReg.NsOwl + "equivalentClass");
	public static final Property OWL_EQUIVALENT_PROPERTY = ResourceFactory
			.createProperty(RdfReg.NsOwl + "equivalentProperty");
	...
	public static final Resource SCHEMAORG_CREATIVE_WORK_SERIES = ResourceFactory
			.createResource(NsSchemaOrg + "CreativeWorkSeries");
	...
	public static final Resource SCHEMAORG_GEO_COORDINATES = ResourceFactory
			.createResource(NsSchemaOrg + "GeoCoordinates");
	...
	public static final Resource SCHEMAORG_POSTAL_ADDRESS = ResourceFactory
			.createResource(NsSchemaOrg + "PostalAddress");
	...
	public static final Resource SCHEMAORG_VISUAL_ARTWORK = ResourceFactory
			.createResource(NsSchemaOrg + "VisualArtwork");
...
//	public static final Resource SCHEMAORG_  = ResourceFactory.createResource(NsSchemaOrg+"");
	...
	public static final Property SCHEMAORG_ALTERNATE_NAME = ResourceFactory
			.createProperty(NsSchemaOrg + "alternateName");
	public static final Property SCHEMAORG_ADDRESS_REGION = ResourceFactory
			.createProperty(NsSchemaOrg + "addressRegion");
	...
	public static final Property SCHEMAORG_CONTENT_LOCATION = ResourceFactory
			.createProperty(NsSchemaOrg + "contentLocation");
	...
	public static final Property SCHEMAORG_ENCODING_FORMAT = ResourceFactory
			.createProperty(NsSchemaOrg + "encodingFormat");
	...
	public static final Property SCHEMAORG_ASSOCIATED_MEDIA = ResourceFactory
			.createProperty(NsSchemaOrg + "associatedMedia");
	...
	public static final Property SCHEMAORG_COPYRIGHT_HOLDER = ResourceFactory
			.createProperty(NsSchemaOrg + "copyrightHolder");
	...
	public static final Property SCHEMAORG_ARTWORK_SURFACE = ResourceFactory
			.createProperty(NsSchemaOrg + "artworkSurface");
	public static final Property SCHEMAORG_TEXT = ResourceFactory.createProperty(NsSchemaOrg + "text");
	public static final Property SCHEMAORG_ADDITIONAL_TYPE = ResourceFactory
			.createProperty(NsSchemaOrg + "additionalType");
	public static final Property SCHEMAORG_LOCATION_CREATED = ResourceFactory
			.createProperty(NsSchemaOrg + "locationCreated");
	public static final Property SCHEMAORG_EXAMPLE_OF_WORK = ResourceFactory
			.createProperty(NsSchemaOrg + "exampleOfWork");
	public static final Property SCHEMAORG_MAIN_ENTITY_OF_PAGE = ResourceFactory
			.createProperty(NsSchemaOrg + "mainEntityOfPage");
	public static final Property SCHEMAORG_AUTHOR = ResourceFactory.createProperty(NsSchemaOrg + "author");
	public static final Property SCHEMAORG_SPATIAL_COVERAGE = ResourceFactory
			.createProperty(NsSchemaOrg + "spatialCoverage");
	public static final Property SCHEMAORG_LOCATION = ResourceFactory.createProperty(NsSchemaOrg + "location");
	public static final Property SCHEMAORG_TEMPORAL_COVERAGE = ResourceFactory
			.createProperty(NsSchemaOrg + "temporalCoverage");
...
//	public static final Property SCHEMAORG_ = ResourceFactory.createProperty(NsSchemaOrg+"");
	...
	public static final Property SCHEMAORG_NUMBER_OF_PAGES = ResourceFactory
			.createProperty(NsSchemaOrg + "numberOfPages");
