package eu.europeana.metis.ldaggregation.segmenter.api.record.io.xml;
...
import eu.europeana.metis.ldaggregation.segmenter.jena.utils.JenaUtils;
...
public class EdmXmlStreamWriter extends EdmXmlDefinitions
{
    private static final QName rdfRdf 
        = new QName(RDF.uri, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.PREFIX, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.RDF);

    private static final QName rdfAbout 
        = new QName(RDF.uri, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.PREFIX, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.about);

    private static final QName rdfResource 
        = new QName(RDF.uri, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.PREFIX, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.resource);

    private static final QName rdfDatatype 
        = new QName(RDF.uri, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.PREFIX, eu.europeana.metis.ldaggregation.segmenter.api.edm.RDF.datatype);
